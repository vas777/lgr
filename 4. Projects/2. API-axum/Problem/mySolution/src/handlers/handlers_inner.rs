...
pub async fn create_question(
    ...
    questions_dao: &(dyn QuestionsDao + Sync + Send),
     ...
     // create question using `questions_dao`
    ...
    match question {
        ...
        Err(err) => {
            ...
            error!("bad thing happen namely {err}");
...
pub async fn read_questions(
    ...
    // get questions using `questions_dao`
...
pub async fn delete_question(
    ...
    // delete question using `questions_dao`
    let result = questions_dao.delete_question(question_uuid.question_uuid.clone()).await; 
...
pub async fn read_answers(
    ...
    match answers {
        ...
        Err(e) => {
            error!("bad thing happen, namely {e}");
